...
function display(){
    ...
    console.log('---------------------------------'); 
    console.log('node main.js 1  -> READ FILE '); 
    console.log('node main.js 2  -> CREATE FILE'); 
    console.log('node main.js 3  -> UPDATE FILE'); 
    console.log('node main.js 4  -> DELETE FILE'); 
    console.log('node main.js 5  -> CREATE FOLDER'); 
    console.log('node main.js 6  -> DELETE FOLDER'); 
    console.log('node main.js 7  -> READ FOLDER'); 
    console.log('node main.js 8  -> UPDATE FOLDER'); 
    console.log('node main.js 9  -> EXIT'); 
    console.log('---------------------------------  \n'); 
}
